...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        templates: {
            ...
            a: '<a class="multiselect dropdown-toggle" data-toggle="dropdown"></a>',
        ...
        buildContainer: function() {
            this.$container = this.options.useAnchorTag ? $(this.$select.parent()): $(this.options.buttonContainer);
        ...
        buildButton: function() {
            this.$button = this.options.useAnchorTag ? $(this.templates.a).addClass(this.options.buttonClass) : $(this.templates.button).addClass(this.options.buttonClass);
            ...
            if( this.$select.prop('id') ){
                this.$button.attr('id', 'toggle_'+this.$select.prop('id'));
            }
        ...
        buildDropdown: function() {
            ...
            if( this.$select.prop('id') ){
                this.$ul.attr('id', 'menu_'+this.$select.prop('id'));
            }
        ...
        updateButtonText: function() {
            ...
            if( this.options.useAnchorTag )
            {
                ...
                $('a.dropdown-toggle', this.$container).html(this.options.buttonText(options, this.$select));
                
                // Now update the title attribute of the button.
                $('a.dropdown-toggle', this.$container).attr('title', this.options.buttonTitle(options, this.$select));
            }else{
                // First update the displayed button text.
